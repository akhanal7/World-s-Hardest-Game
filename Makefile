...
OFILES = main.o mylib.o game.o winscreen.o gameoverscreen.o welcomescreen.o background.o spaceship.o font.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h winscreen.h gameoverscreen.h welcomescreen.h background.h spaceship.h
